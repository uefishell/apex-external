...
bool ImGui::subtab2(const char* icon, const char* label, bool selected)
{
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    window->DrawList->AddRectFilled(pos, ImVec2(pos.x + 2, pos.y + size.y), ImColor(157, 176, 242, int(255 * it_filled->second)));
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    window->DrawList->AddRectFilled(clickable.Min, clickable.Max, ImColor(15,15,15), 0);
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    if (hovered || selected)
    {
        window->DrawList->AddRectFilled(pos, ImVec2(pos.x + 2, pos.y + size.y + 0), ImColor(157, 176, 242, int(255)));
    ...
    RenderTextClipped(ImVec2(pos.x + 9, pos.y), ImVec2(pos.x + 10, pos.y + size.y), label, NULL, &label_size, style.SelectableTextAlign, &bb);
